...
int main() {
    ...
    if (station1.k * outDir < 0) std::cout << "Collision in outgoing direction" << std::endl;
    if (station2.k * incDir < 0) std::cout << "Collision in incoming direction" << std::endl;
}